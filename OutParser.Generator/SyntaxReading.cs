...
internal static class SyntaxReading {
    ...
    private class PatternData(string reducedPattern, string separator, int count, int readIndex) {
        ...
        public int ReadIndex {get; } = readIndex;
...
#pragma warning restore RSEXPERIMENTAL002 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
        ...
        foreach (var pattern in patterns) {
            ...
            patternData = new PatternData(reducedPattern, separator, 1, patternList.Count);
        ...
        foreach (var argument in operation.Arguments.Skip(2)) {
            ...
            patternData.ParameterIndex = argumentIndex++;
        }
        ...
        // Order types based on parameter index
        var outCallDataList = new List<OutCallData>();
